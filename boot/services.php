...
$di->set('process',                 \Core\Services\Process::class, false);
...
$di->set('exception-handler',       \Core\Handlers\ExceptionHandler::class, true);
...
$di->set('shutdown-handler',        \Core\Handlers\ShutdownHandler::class, true);
