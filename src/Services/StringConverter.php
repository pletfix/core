 ...
 *
 * This class based on Laravel's Str class and Laravel' Pluralizer by Taylor Otwell, which again used the Doctrine's Inflector
 * (https://github.com/doctrine/inflector/blob/1.1.x/LICENSE MIT License).
 *
 * $charsArray for the ascii method is adapted from Stringy by Daniel St. Jules (https://github.com/danielstjules/Stringy/blob/2.3.1/LICENSE.txt MIT License)
 *
...
class StringConverter
{
    ...
    public static function snake($word)
    {
        ...
        // Laravel: todo ergebnis verglecichen
//        if (!ctype_lower($word)) {
...
//        return $value;
     ...
     * @return string
     */
    public static function pascal($word)
    {
    ...
    {
        return lcfirst(self::pascal($word));
    }
     ...
     * @return string
     */
    public static function title($word)
    {
