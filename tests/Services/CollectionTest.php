...
/**
 * This test is copied from Laravel's Collection Test ([MIT License](https://github.com/laravel/framework/blob/5.4/LICENSE.md)).
 *
 * @see https://github.com/laravel/framework/blob/5.4/tests/Support/SupportCollectionTest.php Collection Test on GitHub
 */
class CollectionTest extends TestCase
{
    ...
    public function testWhere()
    {
        ...
        $this->assertEquals(
            [['v' => 3], ['v' => '3']],
            $c->where('v', 3, 'garbage')->values()->all()
        );
        $this->assertEquals(
            [['v' => 3]],
            $c->where('v', 3, '===')->values()->all()
    ...
    {
        $c = new Collection([['v' => 1], ['v' => 2], ['v' => 3], ['v' => '3'], ['v' => 4]]);
        $this->assertEquals([['v' => 2], ['v' => '3'], ['v' => 4]], $c->whereNotIn('v', [1, 3], true)->values()->all());
    }
    ...
    public function testChunk()
    {
        ...
        /** @var Collection $c */
        $c = $data[3];
        $this->assertEquals([9 => 10], $c->toArray());
    }
    ...
    public function testConstructorFromNull()
    {
        $collection = new Collection(null);
    ...
    public function testConstructorFromCollection()
    {
    ...
    public function testContains()
    {
        ...
        $this->assertTrue($c->contains(1, 'v'));
        $this->assertFalse($c->contains(2, 'v'));
    ...
    public function testContainsStrict()
    {
        ...
        $this->assertTrue($c->containsStrict(1, 'v'));
        $this->assertFalse($c->containsStrict(2, 'v'));
        $this->assertFalse($c->containsStrict(4, 'v'));
        $this->assertTrue($c->containsStrict('04', 'v'));
